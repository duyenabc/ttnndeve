  ...
  <div class="ims-scope w-full mx-auto space-y-6 font-sans pb-20">
    ...
    <div>
      <nav class="flex items-center gap-2 text-xs text-slate-500 mb-2">
        ...
        <span class="material-symbols-outlined text-[14px]">chevron_right</span>
        <span class="font-bold text-slate-900">PhÃª duyá»‡t Ä‘á» tÃ i</span>
      </nav>
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <h1 class="text-[28px] font-bold text-slate-900 tracking-tight">PhÃª duyá»‡t & Quáº£n lÃ½ Äá» tÃ i Thá»±c táº­p</h1>
      </div>
    </div>
    ...
    <div class="flex items-center gap-8 border-b border-slate-200">
      ...
      <router-link
        ...
        class="pb-3 text-blue-700 border-b-2 border-blue-700 font-bold text-sm flex items-center gap-1.5"
      >
      ...
      <div class="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4">
        <div class="relative flex-1">
          ...
          <input
            v-model="searchQuery"
            type="text"
            placeholder="TÃ¬m kiáº¿m tÃªn Ä‘á» tÃ i, tÃªn sinh viÃªn, MSSV..."
        ...
        <table class="w-full text-left border-collapse text-xs">
          <thead>
            <tr class="bg-slate-50 border-b border-slate-200 font-bold uppercase text-[10px] text-slate-500">
              ...
              <th class="px-6 py-3.5">Sinh viÃªn / NhÃ³m</th>
              <th class="px-6 py-3.5">ÄÆ¡n vá»‹ thá»±c táº­p</th>
              <th class="px-6 py-3.5 text-center">NgÃ y Ä‘Äƒng kÃ½</th>
              <th class="px-6 py-3.5">Tráº¡ng thÃ¡i duyá»‡t</th>
          ...
          <tbody class="divide-y divide-slate-100">
            <tr v-if="loadingStudents">
              <td colspan="6" class="p-10 text-center text-slate-500 font-medium">
                Äang táº£i danh sÃ¡ch Ä‘á» tÃ i sinh viÃªn...
              </td>
            </tr>
            <tr v-else-if="!hasRegisteredTopics">
              <td colspan="6" class="p-16 text-center text-slate-500">
                ...
                <div class="text-sm font-bold text-slate-700">ChÆ°a cÃ³ Ä‘á» tÃ i nÃ o Ä‘Æ°á»£c Ä‘Äƒng kÃ½</div>
                <p class="text-slate-400 text-xs mt-1 max-w-md mx-auto leading-relaxed">
                  CÃ¡c sinh viÃªn trong lá»›p há»c nÃ y hiá»‡n táº¡i chÆ°a cÃ³ Ä‘á» tÃ i thá»±c táº­p nÃ o Ä‘Æ°á»£c Ä‘Äƒng kÃ½.
                </p>
              </td>
            </tr>
            <tr v-else-if="!filteredTopics.length">
              <td colspan="6" class="p-12 text-center text-slate-500">
                ...
                ChÆ°a tÃ¬m tháº¥y Ä‘á» tÃ i nÃ o khá»›p vá»›i bá»™ lá»c hiá»‡n táº¡i.
              </td>
            </tr>
            <tr
              v-else
              ...
              <td class="px-6 py-4 text-center relative">
                <div class="flex items-center justify-center gap-2">
                  ...
                  <button
                    ...
                    title="Má»Ÿ khÃ³a cho sinh viÃªn sá»­a láº¡i"
                  >
      ...
      <div class="w-full max-w-lg bg-white h-full shadow-2xl flex flex-col justify-between p-6 overflow-y-auto font-sans">
        <div class="space-y-5">
          ...
          <div class="grid grid-cols-2 gap-2.5 p-3.5 bg-slate-50 rounded-2xl text-xs text-slate-700 border border-slate-200">
            <div>
              <span class="text-[10px] text-slate-400 font-bold uppercase block">NhÃ³m / HÃ¬nh thá»©c</span>
            ...
            <div>
              <span class="text-[10px] text-slate-400 font-bold uppercase block">ÄÆ¡n vá»‹ thá»±c táº­p</span>
              <span class="font-bold text-slate-800">{{ selectedTopic.company }}</span>
            </div>
            <div>
              <span class="text-[10px] text-slate-400 font-bold uppercase block">Vá»‹ trÃ­ thá»±c táº­p</span>
          ...
          <div v-if="selectedTopic.members && selectedTopic.members.length > 0" class="p-3 bg-blue-50/50 rounded-2xl border border-blue-100 space-y-2">
            <div class="flex items-center justify-between text-xs">
              <span class="font-bold text-slate-900 flex items-center gap-1.5">
                ...
                ThÃ nh viÃªn thá»±c hiá»‡n chung Ä‘á» tÃ i nÃ y:
              </span>
              <span class="text-[10px] font-bold text-[#005EA3]">
                {{ selectedTopic.members.length }} sinh viÃªn
              </span>
            </div>
            <div class="space-y-1.5">
              ...
              >
                ...
                <span
                  ...
                  :class="m.role === 'TrÆ°á»Ÿng nhÃ³m' ? 'bg-[#005EA3] text-white' : 'bg-slate-100 text-slate-600'"
                >
                  {{ m.role }}
                </span>
              </div>
          ...
          <div class="space-y-1 text-xs">
            <label class="font-bold text-slate-900 block">Ã kiáº¿n pháº£n há»“i / LÃ½ do tá»« chá»‘i, chá»‰nh sá»­a *</label>
            <textarea
              v-model="feedbackText"
              rows="4"
              placeholder="Nháº­p Ã½ kiáº¿n pháº£n há»“i cá»¥ thá»ƒ cho sinh viÃªn..."
        ...
        <div class="pt-4 border-t border-slate-100 grid grid-cols-3 gap-2">
          ...
          <button
            @click="handleStatusUpdate('YÃªu cáº§u chá»‰nh sá»­a')"
      ...
      <div class="w-full max-w-md bg-white h-full shadow-2xl flex flex-col justify-between p-6">
        <div class="space-y-4">
          <div class="flex justify-between items-center border-b pb-3">
            <h3 class="font-bold text-base text-slate-900">Má»Ÿ khÃ³a chá»‰nh sá»­a Ä‘á» tÃ i</h3>
            <button @click="unlockDrawerTopic = null" class="text-slate-400 hover:text-slate-600">âœ•</button>
          </div>

          <p class="text-xs text-slate-600">
            Sinh viÃªn <strong>{{ unlockDrawerTopic.student }}</strong> sáº½ Ä‘Æ°á»£c phÃ©p cáº­p nháº­t láº¡i tÃªn Ä‘á» tÃ i vÃ  file Ä‘á» cÆ°Æ¡ng Ä‘Ã­nh kÃ¨m.
          </p>
          ...
          <div class="space-y-1 text-xs">
            ...
            <textarea
              ...
              rows="5"
              placeholder="Nháº­p lÃ½ do má»Ÿ láº¡i cho sinh viÃªn chá»‰nh sá»­a..."
              class="w-full px-3.5 py-2.5 rounded-xl border text-xs outline-none focus:ring-2 focus:ring-blue-600 transition"
    ...
    >
      <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 space-y-4">
        <h3 class="font-bold text-lg text-slate-900">
          {{ isRegistrationLocked ? 'Má»Ÿ láº¡i quyá»n Ä‘Äƒng kÃ½ Ä‘á» tÃ i?' : 'KhÃ³a quyá»n Ä‘Äƒng kÃ½ Ä‘á» tÃ i cá»§a lá»›p?' }}
        </h3>
        <p class="text-xs text-slate-600 leading-relaxed">
          {{ isRegistrationLocked
            ? 'Sinh viÃªn cÃ³ thá»ƒ tiáº¿p tá»¥c chá»‰nh sá»­a, lÆ°u nhÃ¡p vÃ  gá»­i duyá»‡t Ä‘á» tÃ i trá»±c tuyáº¿n.'
            : 'Sinh viÃªn chÆ°a Ä‘Äƒng kÃ½ hoáº·c Ä‘á» tÃ i Ä‘ang á»Ÿ tráº¡ng thÃ¡i NhÃ¡p/YÃªu cáº§u sá»­a sáº½ khÃ´ng thá»ƒ ná»™p bÃ i ná»¯a.' }}
        </p>
...
<script setup>
  ...
  const topicHistoryList = computed(() => {
    ...
    if (selectedTopic.value.mssv === '20241001') {
      list.push({
        ...
        title: 'XÃ¢y dá»±ng Há»‡ thá»‘ng Quáº£n lÃ½ Thá»±c táº­p Doanh nghiá»‡p (IMS) dá»±a trÃªn Kiáº¿n trÃºc Microservices',
        file: 'De_cuong_chi_tiet_De_tai_IMS.pdf',
        feedback: 'Äá» tÃ i ráº¥t tá»‘t, bÃ¡m sÃ¡t thá»±c tiá»…n táº¡i doanh nghiá»‡p FPT. Khuyáº¿n khÃ­ch hoÃ n thÃ nh Ä‘Ãºng tiáº¿n Ä‘á»™.'
      });
      list.push({
        round: 'VÃ²ng 1',
        date: '10/10/2024 14:30',
        status: 'YÃªu cáº§u chá»‰nh sá»­a',
        ...
        feedback: 'TÃªn Ä‘á» tÃ i quÃ¡ rá»™ng, cáº§n thu háº¹p pháº¡m vi Ã¡p dá»¥ng vÃ o má»™t dá»± Ã¡n thá»±c táº¿ cá»¥ thá»ƒ.'
      });
    } else {
      ...
      if (selectedTopic.value.status === 'ÄÃ£ duyá»‡t') {
        list.push({
          ...
          feedback: selectedTopic.value.feedback || 'Äá» tÃ i há»£p lá»‡, Ä‘Æ°á»£c phÃª duyá»‡t thá»±c hiá»‡n.'
        });
        ...
        list.push({
          ...
          title: selectedTopic.value.title,
          file: selectedTopic.value.file || 'Proposal_v1.pdf',
          feedback: selectedTopic.value.feedback || 'Äá» tÃ i khÃ´ng phÃ¹ há»£p vá»›i má»¥c tiÃªu thá»±c táº­p.'
        });
      } else if (selectedTopic.value.status === 'YÃªu cáº§u chá»‰nh sá»­a') {
        list.push({
          round: 'VÃ²ng 1',
          date: selectedTopic.value.date || 'HÃ´m nay',
          status: 'YÃªu cáº§u chá»‰nh sá»­a',
          ...
          title: selectedTopic.value.title,
          file: selectedTopic.value.file || 'Proposal_v1.pdf',
          feedback: selectedTopic.value.feedback || 'Cáº§n bá»• sung chi tiáº¿t sÆ¡ Ä‘á»“ thiáº¿t káº¿ há»‡ thá»‘ng.'
        });
        ...
        list.push({
          ...
          title: selectedTopic.value.title,
          file: selectedTopic.value.file || 'Proposal_v1.pdf',
          feedback: 'Äang Ä‘á»£i giáº£ng viÃªn cháº¥m duyá»‡t.'
        });
      }
    }
  ...
  const statusOptions = computed(() => {
    return [
      ...
      { value: 'YÃªu cáº§u chá»‰nh sá»­a', label: 'YÃªu cáº§u sá»­a', count: topics.value.filter(t => t.status === 'YÃªu cáº§u chá»‰nh sá»­a').length },
    ...
    try {
      ...
      topics.value = studentList.map((s, idx) => {
        return {
          ...
          status: 'ChÆ°a ná»™p',
          file: null,
          description: 'Sinh viÃªn chÆ°a ná»™p Ä‘á» tÃ i thá»±c táº­p. Háº¡n Ä‘Äƒng kÃ½ cÃ²n hiá»‡u lá»±c.'
        };
      });
      ...
      topics.value.forEach(t => {
        ...
        if (savedStatus) {
          ...
          else if (savedStatus === 'rejected') t.status = 'YÃªu cáº§u chá»‰nh sá»­a';
        ...
        firestoreTopics.forEach(ft => {
          ...
          if (!t) {
            t = {
              ...
              student: ft.studentName || 'Sinh viÃªn má»›i',
              isGroup: ft.group && ft.group !== 'ChÆ°a cÃ³ nhÃ³m',
              groupName: ft.group || 'CÃ¡ nhÃ¢n',
              members: [{ name: ft.studentName || 'Sinh viÃªn má»›i', mssv: mssv, role: 'CÃ¡ nhÃ¢n' }],
              mssv: mssv,
              ...
              status: 'ChÆ°a ná»™p',
              file: ft.file || null,
              description: ft.description || 'Sinh viÃªn chÆ°a ná»™p Ä‘á» tÃ i thá»±c táº­p.'
            };
            topics.value.push(t);
          }
          ...
          if (ft.status) {
            ...
            else if (st === 'Approved' || lower === 'approved' || lower === 'Ä‘Ã£ duyá»‡t') t.status = 'ÄÃ£ duyá»‡t';
            else if (st === 'Requested Changes' || st === 'RequestedChanges' || lower === 'requested_changes' || lower === 'requested changes' || lower === 'yÃªu cáº§u chá»‰nh sá»­a' || lower === 'yÃªu cáº§u sá»­a' || (lower === 'rejected' && st !== 'Rejected' && st !== 'rejected_final')) t.status = 'YÃªu cáº§u chá»‰nh sá»­a';
  ...
  function confirmToggleLock() {
    ...
    showToast(isRegistrationLocked.value ? 'âœ“ ÄÃ£ khÃ³a quyá»n Ä‘Äƒng kÃ½ Ä‘á» tÃ i cá»§a lá»›p' : 'âœ“ ÄÃ£ má»Ÿ láº¡i quyá»n Ä‘Äƒng kÃ½ Ä‘á» tÃ i cho lá»›p');
  }
  ...
  function confirmUnlockEdit() {
    ...
    if (unlockDrawerTopic.value) {
      ...
      unlockDrawerTopic.value.status = 'YÃªu cáº§u chá»‰nh sá»­a';
      ...
      sendRealtimeNotification({
        role: 'SinhVien',
        userId: mssv,
        title: 'Giáº£ng viÃªn Ä‘Ã£ má»Ÿ khÃ³a sá»­a Ä‘á» tÃ i',
        content: `Giáº£ng viÃªn Ä‘Ã£ má»Ÿ quyá»n cho phÃ©p báº¡n chá»‰nh sá»­a láº¡i Ä‘á» tÃ i. LÃ½ do: ${unlockReason.value}`,
        icon: 'lock_open',
        bgClass: 'bg-blue-100 text-blue-700',
        link: '/student/progress'
      });

      showToast(`ÄÃ£ má»Ÿ khÃ³a cho sinh viÃªn ${unlockDrawerTopic.value.student} sá»­a láº¡i Ä‘á» tÃ i!`);
  ...
  function handleStatusUpdate(newStatus) {
    ...
    if (newStatus !== 'ÄÃ£ duyá»‡t' && !feedbackText.value.trim()) {
      ...
      if (newStatus === 'YÃªu cáº§u chá»‰nh sá»­a' || newStatus === 'YÃªu cáº§u sá»­a') {
        feedbackErrorText.value = 'Vui lÃ²ng nháº­p ghi chÃº cá»¥ thá»ƒ cáº§n chá»‰nh sá»­a';
        showToast('Vui lÃ²ng nháº­p ghi chÃº cá»¥ thá»ƒ cáº§n chá»‰nh sá»­a');
    ...
    if (selectedTopic.value) {
      ...
      else if (newStatus === 'YÃªu cáº§u chá»‰nh sá»­a') mappedStatus = 'rejected';
      ...
      sendRealtimeNotification({
        role: 'SinhVien',
        userId: mssv,
        title: `Äá» tÃ i thá»±c táº­p: ${newStatus}`,
        ...
        icon: newStatus === 'ÄÃ£ duyá»‡t' ? 'verified' : (newStatus === 'YÃªu cáº§u chá»‰nh sá»­a' ? 'rate_review' : 'cancel'),
        bgClass: newStatus === 'ÄÃ£ duyá»‡t' ? 'bg-emerald-100 text-emerald-700' : (newStatus === 'YÃªu cáº§u chá»‰nh sá»­a' ? 'bg-amber-100 text-amber-800' : 'bg-rose-100 text-rose-700'),
        link: '/student/progress'
      });

      showToast(`âœ“ ÄÃ£ cáº­p nháº­t tráº¡ng thÃ¡i Ä‘á» tÃ i sang "${newStatus}" vÃ  gá»­i thÃ´ng bÃ¡o thá»i gian thá»±c!`);
