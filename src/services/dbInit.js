...
const INITIAL_USERS = [
  ...
  },
  {
    maNguoiDung: 3,
    maDinhDanh: 'gv001',
    hoTen: 'Nguyễn Văn Thành (Mock)',
    email: 'gv001@due.udn.vn',
  ...
  },
  {
    maNguoiDung: 4,
    maDinhDanh: 'sv001',
    hoTen: 'Trần Thị Lan (Mock)',
    email: 'sv001@due.udn.vn',
...
const INITIAL_CLASSES = [
  {
    maLop: 101,
    tenLop: 'Mock_Class_2025',
    maKy: 1,
    tenKy: 'Tốt nghiệp - HK2 - 2025-2026',
    maGiangVien: 3,
    tenGiangVien: 'Nguyễn Văn Thành (Mock)',
    ghiDanhMo: true,
